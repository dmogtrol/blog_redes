...
function about() {
  ...
  div.innerHTML = `
    ...
    <h2 class="articulo-all-name">Artículos</h2>
  ...
  div.innerHTML = `
    ...
    <div class="article-container">
      <section class="individual-article">
        ...
        <div class="volver"><a href="#/about">volver</a></div>
  ...
  div.innerHTML = `
    <div class="article-container">
      <section class="individual-article">
        ...
        <p class="text">Somos estudiantes de informática de la sección 01 del Trayecto 2 Trimestre 1 de la Universidad Politécnica Territorial de Falcón "Alonso Gamero" y decidimos crear este blog con la finalidad de compartir los conocimientos que hemos adquirido durante este trimestre sobre las Redes de Computadoras, si tienes alguna duda, no dudes en contactarnos :) </p>
		
		<h5>Autores</h5>
		<ul>
          <li>José Graterol C.I: 26.626.684 | Telf: 0424.660.3768</li>
		  <li>Diego Medina C.I: 31.620.309 | Telf: 0426.366.2640</li>
		  <li>Daniel Oviedo C.I: 30.126.317 | Telf: 0412.966.6911</li>
		  <li>Guillermo Yari C.I: 28.446.192 | Telf: 0412.682.4062</li> 
        </ul>
...
//         <p>
//           Sección 01 – T2 T1
//           Graterol José C.I: 26.626.684
//           Medina Diego C.I: 31.620.309
//           Yari Guillermo C.I: 28.446.192
//           Oviedo Daniel C.I: 30.126.317

//         </p>
//         <p>Tu sitio web es a menudo la primera experiencia que tiene la gente con tu marca. Haz que tu primera impresión cuente.</p>
//         <p>Tu sitio web es a menudo la primera experiencia que tiene la gente con tu marca. Haz que tu primera impresión cuente.</p>
//         <p>Tu sitio web es a menudo la primera experiencia que tiene la gente con tu marca. Haz que tu primera impresión cuente.</p>
